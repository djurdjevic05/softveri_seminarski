...
public class GlavnaServerskaForma extends javax.swing.JFrame {
    PokreniServer pokreniServerNit;
    /**
    ...
    private void initComponents() {
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addComponent(lblStatusServera, javax.swing.GroupLayout.PREFERRED_SIZE, 224, javax.swing.GroupLayout.PREFERRED_SIZE))))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(lblStatus)
                    .addComponent(lblStatusServera, javax.swing.GroupLayout.PREFERRED_SIZE, 14, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(27, 27, 27)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
        ...
        jmiPodesavanjaServera.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jmiPodesavanjaServeraActionPerformed(evt);
            }
        });
        jMenu1.add(jmiPodesavanjaServera);
    ...
    private void btnPokreniServerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPokreniServerActionPerformed
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "Port mora biti ceo broj!", "Greska", JOptionPane.ERROR_MESSAGE);
            return;
        }
    ...
    private void jmiPodesavanjaServeraActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jmiPodesavanjaServeraActionPerformed
       JDialog formaPodesavanje = new FPodesavanjeServera(this, true);
       formaPodesavanje.setVisible(true);
    }//GEN-LAST:event_jmiPodesavanjaServeraActionPerformed
    ...
    private void pokreniServer(int port) {
        pokreniServerNit = new PokreniServer(this,port);
    ...
    public void zaustavljenServer(){
        pokreniServerNit.zaustaviServer();
